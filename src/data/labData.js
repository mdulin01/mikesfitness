...
export const labHistory = [
  ...
  },
  {
    ...
    values: {
      ...
      'WBC': { value: 5.7, unit: 'x10E3/uL', flag: null, ref: '3.4-10.8' },
      'RBC': { value: 5.45, unit: 'x10E6/uL', flag: null, ref: '4.14-5.80' },
      'Hemoglobin': { value: 16.4, unit: 'g/dL', flag: null, ref: '13.0-17.7' },
      'Hematocrit': { value: 49.7, unit: '%', flag: null, ref: '37.5-51.0' },
      'MCV': { value: 91, unit: 'fL', flag: null, ref: '79-97' },
      'MCH': { value: 30.1, unit: 'pg', flag: null, ref: '26.6-33.0' },
      'MCHC': { value: 33.0, unit: 'g/dL', flag: null, ref: '31.5-35.7' },
      'RDW': { value: 13.3, unit: '%', flag: null, ref: '11.6-15.4' },
      'Platelets': { value: 171, unit: 'x10E3/uL', flag: null, ref: '150-450', note: 'Recovered into normal range — first time since 2024' },
      'Neutrophils': { value: 53, unit: '%', flag: null, ref: 'Not Estab.' },
      'Lymphocytes': { value: 33, unit: '%', flag: null, ref: 'Not Estab.' },
      'Monocytes': { value: 10, unit: '%', flag: null, ref: 'Not Estab.' },
      'Eosinophils': { value: 3, unit: '%', flag: null, ref: 'Not Estab.' },
      'Basophils': { value: 1, unit: '%', flag: null, ref: 'Not Estab.' },
      'Neutrophil Abs': { value: 3.0, unit: 'x10E3/uL', flag: null, ref: '1.4-7.0' },
      'Lymphocyte Abs': { value: 1.9, unit: 'x10E3/uL', flag: null, ref: '0.7-3.1' },
      'Monocyte Abs': { value: 0.5, unit: 'x10E3/uL', flag: null, ref: '0.1-0.9' },
      'Eosinophil Abs': { value: 0.2, unit: 'x10E3/uL', flag: null, ref: '0.0-0.4' },
      'Basophil Abs': { value: 0.0, unit: 'x10E3/uL', flag: null, ref: '0.0-0.2' },
      // CMP
      'Glucose': { value: 80, unit: 'mg/dL', flag: null, ref: '70-99' },
      'BUN': { value: 20, unit: 'mg/dL', flag: null, ref: '6-24' },
      'Creatinine': { value: 1.30, unit: 'mg/dL', flag: 'high', ref: '0.76-1.27' },
      'eGFR': { value: 63, unit: 'mL/min/1.73', flag: null, ref: '>59' },
      'Sodium': { value: 142, unit: 'mmol/L', flag: null, ref: '134-144' },
      'Potassium': { value: 4.4, unit: 'mmol/L', flag: null, ref: '3.5-5.2' },
      'Chloride': { value: 104, unit: 'mmol/L', flag: null, ref: '96-106' },
      'CO2': { value: 22, unit: 'mmol/L', flag: null, ref: '20-29' },
      'Calcium': { value: 9.6, unit: 'mg/dL', flag: null, ref: '8.7-10.2' },
      'Protein': { value: 6.9, unit: 'g/dL', flag: null, ref: '6.0-8.5' },
      'Albumin': { value: 4.9, unit: 'g/dL', flag: null, ref: '3.8-4.9' },
      'Globulin': { value: 2.0, unit: 'g/dL', flag: null, ref: '1.5-4.5' },
      'Bilirubin': { value: 0.8, unit: 'mg/dL', flag: null, ref: '0.0-1.2' },
      'ALP': { value: 60, unit: 'IU/L', flag: null, ref: '47-123' },
      'AST': { value: 22, unit: 'IU/L', flag: null, ref: '0-40' },
      'ALT': { value: 18, unit: 'IU/L', flag: null, ref: '0-44' },
      // Lipid Panel
      'Total Cholesterol': { value: 141, unit: 'mg/dL', flag: null, ref: '100-199' },
      'Triglycerides': { value: 77, unit: 'mg/dL', flag: null, ref: '0-149' },
      'HDL-C': { value: 52, unit: 'mg/dL', flag: null, ref: '>39' },
      'VLDL': { value: 11, unit: 'mg/dL', flag: null, ref: '5-40' },
      'LDL-C': { value: 78, unit: 'mg/dL', flag: null, ref: '0-99', note: 'First time below 100 — statin/ezetimibe working' },
      'ApoB': { value: 75, unit: 'mg/dL', flag: null, ref: '<90', note: 'Down from 111 — now in desirable range' },
      // Inflammation / Other
      'CRP': { value: 0.38, unit: 'mg/L', flag: null, ref: '0-3.0' },
      'Homocysteine': { value: 16.0, unit: 'umol/L', flag: 'high', ref: '0-14.5', note: 'Down from 21.4 but still elevated — continue B-vitamins' },
      'HbA1c': { value: 5.0, unit: '%', flag: null, ref: '4.8-5.6' },
      'Vitamin D': { value: 49.5, unit: 'ng/mL', flag: null, ref: '30.0-100.0' },
      'Vitamin B12': { value: 775, unit: 'pg/mL', flag: null, ref: '232-1245' },
      // Cystatin C with eGFR
      'Cystatin C': { value: 1.00, unit: 'mg/L', flag: null, ref: '0.67-1.14' },
      'eGFR (Cystatin C)': { value: 78, unit: 'mL/min/1.73', flag: null, ref: '>59', note: 'Cystatin-based eGFR higher than creatinine-based (63) — kidney function may be better than Cr suggests' },
      // Urine ACR
      'Urine Creatinine': { value: 29.6, unit: 'mg/dL', flag: null, ref: 'Not Estab.' },
      'Urine Albumin': { value: '<3.0', unit: 'ug/mL', flag: null, ref: 'Not Estab.' },
      'Alb/Creat Ratio': { value: '<10', unit: 'mg/g creat', flag: null, ref: '0-29' },
      // Infectious disease screens (all negative/non-reactive)
      'HBsAg': { value: 'Negative', unit: '', flag: null, ref: 'Negative' },
      'HBs Ab': { value: 'Reactive', unit: '', flag: null, ref: '', note: 'Immune to HBV (vaccination)' },
      'HBc Ab': { value: 'Negative', unit: '', flag: null, ref: 'Negative' },
      'HCV Ab': { value: 'Non Reactive', unit: '', flag: null, ref: 'Non Reactive' },
      'RPR': { value: 'Non Reactive', unit: '', flag: null, ref: 'Non Reactive' },
      'Chlamydia trachomatis': { value: 'Negative', unit: '', flag: null, ref: 'Negative' },
      'Neisseria gonorrhoeae': { value: 'Negative', unit: '', flag: null, ref: 'Negative' },
      // Note: HIV Ab/p24, Ct/GC Rectal, Ct/GC Pharyngeal — specimen issues, not run
    },
  },
];
...
export const keyMetrics = [
  ...
  { id: 'apoB', label: 'ApoB', current: 75, goal: 70, unit: 'mg/dL', direction: 'lower', category: 'heart', lastDate: '2026-04-27' },
  { id: 'ldl', label: 'LDL-C', current: 78, goal: 70, unit: 'mg/dL', direction: 'lower', category: 'heart', lastDate: '2026-04-27' },
  ...
  { id: 'homocysteine', label: 'Homocysteine', current: 16.0, goal: 10, unit: 'umol/L', direction: 'lower', category: 'heart', lastDate: '2026-04-27' },
  { id: 'egfr', label: 'eGFR', current: 63, goal: null, goalLabel: 'stable', unit: 'mL/min', direction: 'higher', category: 'kidney', lastDate: '2026-04-27' },
  { id: 'cystatinC', label: 'Cystatin C', current: 1.00, goal: null, goalLabel: '0.67-1.14', unit: 'mg/L', direction: 'lower', category: 'kidney', lastDate: '2026-04-27' },
  { id: 'creatinine', label: 'Creatinine', current: 1.30, goal: null, goalLabel: '< 1.27', unit: 'mg/dL', direction: 'lower', category: 'kidney', lastDate: '2026-04-27' },
  { id: 'hba1c', label: 'HbA1c', current: 5.0, goal: null, goalLabel: '< 5.7', unit: '%', direction: 'lower', category: 'metabolic', lastDate: '2026-04-27' },
  { id: 'crp', label: 'hs-CRP', current: 0.38, goal: null, goalLabel: '< 1.0', unit: 'mg/L', direction: 'lower', category: 'inflammation', lastDate: '2026-04-27' },
  { id: 'platelets', label: 'Platelets', current: 171, goal: 150, unit: 'x10E3', direction: 'higher', category: 'blood', lastDate: '2026-04-27' },
  { id: 'vitD', label: 'Vitamin D', current: 49.5, goal: null, goalLabel: '40-60', unit: 'ng/mL', direction: 'maintain', category: 'vitamins', lastDate: '2026-04-27' },
  { id: 'b12', label: 'Vitamin B12', current: 775, goal: null, goalLabel: '232-1245', unit: 'pg/mL', direction: 'maintain', category: 'vitamins', lastDate: '2026-04-27' },
];
...
export const monitoringSchedule = [
  { test: 'Lipids / ApoB', frequency: 'Every 6 months', nextDue: '2026-10', category: 'heart' },
  { test: 'CMP (kidney)', frequency: 'Every 6 months', nextDue: '2026-10', category: 'kidney' },
  { test: 'Cystatin C', frequency: 'Every 6 months', nextDue: '2026-10', category: 'kidney' },
  { test: 'Homocysteine', frequency: 'Every 6 months', nextDue: '2026-10', category: 'heart' },
  { test: 'Vitamin B12', frequency: 'Yearly', nextDue: '2027-04', category: 'vitamins' },
  { test: 'Testosterone', frequency: 'Yearly', nextDue: '2027-03', category: 'hormonal' },
